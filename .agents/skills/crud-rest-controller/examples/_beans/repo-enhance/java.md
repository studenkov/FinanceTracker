...
Add `org.springframework.data.jpa.repository.JpaSpecificationExecutor<${EntityFqn}>` to the repository interface extends
list.
...
Skip this fragment -- only applied when ALL of: (1) filter is selected, (2) entity is a JPA entity (has @Entity
annotation), (3) repo does not already extend JpaSpecificationExecutor.

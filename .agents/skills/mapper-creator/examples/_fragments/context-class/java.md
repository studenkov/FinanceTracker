...
Context helper methods are generated per aggregate reference attribute. Their exact form depends on whether the
attribute is a collection, child of collection, etc. Each attribute generates one helper method that uses the context
record fields.
